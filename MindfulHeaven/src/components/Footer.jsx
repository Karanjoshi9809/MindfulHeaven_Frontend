    ...
    return (
        <div id="footer" className="bg-[#f7f7ef] p-4 w-full box-border shadow-lg sticky top-0">
            ...
            <div className="m-auto w-[35rem] font-bold text-center pt-4">
                <p>If you are in a life threatening situation - don't use this site. Call <u className='text-[#eb8458]'>988</u> or <u className='text-[#eb8458]'>use these resources</u> to get immediate help</p>
            </div>
        </div>
    )
}
